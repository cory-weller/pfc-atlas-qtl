...
if [[ ! -f 'HBCC_bam_file_paths.txt' ]]; then
    find /data/CARD_singlecell/Brain_atlas/HBCC_multiome/batch{1,2,3,4,5}/Multiome/ -name 'gex_possorted_bam.bam' > HBCC_bam_file_paths.txt
fi
...
if [[ ! -f 'hg38_chr.reorder.map' ]]; then
